...
REM /************************************************************************/
REM /* This script runs the GetValue application.  It requires three        */
REM /* parameters:                                                          */
...
@echo on
@java -classpath ..\classes;..\classes\* -Djava.util.logging.config.file=..\classes\logging.properties GetValue %1 %2 %3
