...
REM /************************************************************************/
REM /* This script runs the StatsSample application.  It requires three     */
REM /* parameters:                                                          */
...
@echo on
@java -classpath ..\classes;..\classes\* -Djava.util.logging.config.file=..\classes\logging.properties StatsSample %1 %2 %3
