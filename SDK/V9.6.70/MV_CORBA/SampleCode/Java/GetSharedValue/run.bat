...
REM /************************************************************************/
REM /* This script runs the GetSharedValue application.  It requires three  */
REM /* parameters:                                                          */
...
@echo on
@java -classpath ..\classes;..\classes\* -Djava.util.logging.config.file=..\classes\logging.properties GetSharedValue %1 %2 %3
