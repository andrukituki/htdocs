...
public class ShUntypedUtilities extends ShUtilities
{
  ...
  public OMElement[] getFieldGroupElements(TUserData userData)
  {
    ...
    //-------------------------------------------------------------------------
    Iterator<OMElement> repositoryDatas = userData.getExtraElement().getChildrenWithName(REPOSITORY_DATA);
    ...
    while (repositoryDatas.hasNext())
    {
      ...
      //-----------------------------------------------------------------------
      OMElement fieldGroupElement = eachRepData.getFirstChildWithName(SERVICE_DATA)
  ...
  {
    super.checkResultCode(resultCode, extendedResult, userData);
