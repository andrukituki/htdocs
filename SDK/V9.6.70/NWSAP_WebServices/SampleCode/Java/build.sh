...
#############################################################################
# List all the java files to be compiled.                                   #
#############################################################################
rm -f untypedjavafiles > /dev/null 2>&1
list_java_files soapstub/untyped/src/com/MetaSwitch/SRB/SOAP untypedjavafiles

rm -f typedjavafiles > /dev/null 2>&1
list_java_files soapstub/typed/src/com/MetaSwitch/SRB/SOAP typedjavafiles
list_java_files soapstub/typed/src/com/MetaSwitch/EMS/SOAP typedjavafiles
list_java_files soapstub/typed/src/com/MetaSwitch/SDP/SOAP typedjavafiles
list_java_files soapstub/typed/src/com/metaswitch/NSRS/SOAP typedjavafiles
list_java_files soapstub/typed/src/org/w3/_2005/_05/xmlmime typedjavafiles
