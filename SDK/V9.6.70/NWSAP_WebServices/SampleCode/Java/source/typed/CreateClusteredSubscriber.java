...
public class CreateClusteredSubscriber
{
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      {
        baseInformation.setBusinessGroupName(subscriberInfo.businessGroupName.toString());
      ...
      baseInformation.setPreferredSite(
                                      subscriberInfo.preferredSite.toString());
      ...
      //-----------------------------------------------------------------------
      // Build the user identity using the bg name (if supplied) and dn.
      //-----------------------------------------------------------------------
      String[] identifiers = null;
      if (subscriberInfo.businessGroupName.toString() != null)
      {
        identifiers = new String[]
                         {subscriberInfo.neName.toString(),                           
    ...
    throws WrongParametersException
  {
    ...
    for (String arg : args)
    {
      ...
      else
      {
        switch (currentArg)
        {
          ...
          case "-preferredsite":
          {
            fields.preferredSite.append(arg);
          }
          break;
    ...
    if (fields.neName.toString() == null)
    {
      throw new WrongParametersException("No NE name was provided");
    }

    if (fields.preferredSite.toString() == null)
    {
  ...
  static class SubscriberInfo
  {
    ...
    Parameter neName = new Parameter(null);
    ...
    Parameter preferredSite = new Parameter(null);
