...
//
// This application uses Sh-Pull to get a subscriber's current base settings,
// and then sends an Sh-Update with an instruction to delete the subscriber.
...
public class DeleteSubscriber
{
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      System.out.println("Subscriber" + dn + " successfully deleted.");
    }
