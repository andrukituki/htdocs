...
REM                                                                          */
REM It assumes that you have a JDK installed and have javac (the Java        */
REM compiler) and java (the Java interpreter) in your PATH.  You should      */
...
if not exist soapstub (
  ...
  java -classpath %AXIS_JARS% org.apache.axis2.wsdl.WSDL2Java -uri ..\..\Definition\ShService.wsdl -u -o soapstub\untyped --noBuildXML --noMessageReceiver --ns2p http://www.metaswitch.com/srb/soap/sh=com.MetaSwitch.SRB.SOAP
  java -classpath %AXIS_JARS% org.apache.axis2.wsdl.WSDL2Java -uri ..\..\Definition\ShServiceTyped.wsdl -g -u -d jaxbri -o soapstub\typed --noBuildXML --noMessageReceiver --namespace2package http://www.metaswitch.com/srb/soap/sh=com.MetaSwitch.SRB.SOAP,http://www.metaswitch.com/srb/soap/sh/userdata=com.MetaSwitch.SRB.SOAP,http://www.metaswitch.com/ems/soap/sh/servicedata=com.MetaSwitch.EMS.SOAP,http://www.metaswitch.com/sdp/soap/sh/servicedata=com.MetaSwitch.SDP.SOAP,http://www.metaswitch.com/nsrs/soap/sh/servicedata=com.MetaSwitch.NSRS.SOAP -Djavax.xml.accessExternalSchema=all
...
REM ***********************************************************************/
REM List all the java files to be compiled.                               */
REM ***********************************************************************/
DEL/S untypedjavafiles >NUL 2>&1
CALL :LIST_JAVA_FILES soapstub\untyped\src\com\metaswitch\SRB\SOAP untypedjavafiles

DEL/S typedjavafiles >NUL 2>&1
CALL :LIST_JAVA_FILES soapstub\typed\src\com\metaswitch\SRB\SOAP typedjavafiles
CALL :LIST_JAVA_FILES soapstub\typed\src\com\metaswitch\EMS\SOAP typedjavafiles
CALL :LIST_JAVA_FILES soapstub\typed\src\com\metaswitch\SDP\SOAP typedjavafiles
CALL :LIST_JAVA_FILES soapstub\typed\src\com\metaswitch\NSRS\SOAP typedjavafiles
CALL :LIST_JAVA_FILES soapstub\typed\src\org\w3\_2005\_05\xmlmime typedjavafiles
